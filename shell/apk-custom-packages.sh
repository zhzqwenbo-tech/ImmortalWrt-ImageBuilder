...
# 仓库内代理相关apk
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES openssl ca-bundle luci-i18n-nikki-zh-cn"
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-mwan3 kmod-usb-net kmod-usb-net-cdc-ether kmod-usb-net-rndis usbutils"
